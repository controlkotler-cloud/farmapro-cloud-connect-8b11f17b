  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="flex items-center gap-3 bg-gradient-to-br from-brand-soft to-card border border-border rounded-lg px-6 py-4 text-sm font-medium text-foreground"
      >
        {banner.icon}
