  ...
  return (
    <Card className="overflow-hidden border-0 shadow-xl bg-brand-soft/30">
      <div className="relative">
        ...
        <CardHeader className="relative bg-secondary/60 pb-8">
              ...
              <div className="flex items-start justify-between">
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <Badge className="bg-brand-soft text-brand-dark px-3 py-1 inline-flex items-center gap-1">
              ...
              <div className="flex flex-wrap items-center gap-6 text-sm text-muted-foreground">
                ...
                {isEnrolled && (
                  <div className="flex items-center gap-2 bg-info/10 px-3 py-2 rounded-lg border border-info/30">
                    ...
                    <span className="font-medium text-info">Inscrito</span>
                  </div>
                )}

                {isCompleted && (
                  <div className="flex items-center gap-2 bg-success/10 px-3 py-2 rounded-lg border border-success/30">
                    <CheckCircle className="h-4 w-4 text-success" />
                    <span className="font-medium text-success">Completado</span>
                  </div>
                )}
              </div>
            </div>
