        ...
        {questions.length === 0 ? (
          ...
          <div className="space-y-4">
            {questions.map((question, index) => (
              <div key={question.id} className="border rounded-lg p-4 hover:bg-muted transition-colors">
                    ...
                    <div className="grid gap-2">
                      {question.options.map((option) => (
                        <div key={option.id} className="flex items-center text-sm p-2 rounded bg-white border">
                          ...
                          <span className={option.is_correct ? 'font-medium text-success' : 'text-muted-foreground'}>
                            {option.option_text}
                          </span>
                        </div>
                      ))}
