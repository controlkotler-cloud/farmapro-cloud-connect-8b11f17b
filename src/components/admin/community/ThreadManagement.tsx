  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Modera y gestiona los hilos de discusión</p>
      </div>
        ...
        {threads.length === 0 && (
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-lg font-medium text-foreground mb-2">No hay hilos</h3>
              <p className="text-muted-foreground">Los hilos aparecerán aquí cuando los usuarios comiencen a crear discusiones</p>
            </CardContent>
          </Card>
        )}
      </div>
