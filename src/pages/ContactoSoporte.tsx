    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-white p-4">
      <div className="max-w-6xl mx-auto py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-orange-800 mb-4">Contacto y Soporte</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl text-orange-800">Información de Contacto</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="bg-orange-50 p-4 rounded-lg">
                <h3 className="font-semibold text-orange-800 mb-2">Soporte Técnico Urgente</h3>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl text-orange-800">Envíanos un Mensaje</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card className="mt-8">
          <CardHeader>
            <CardTitle className="text-2xl text-orange-800">Preguntas Frecuentes</CardTitle>
          </CardHeader>
          <CardContent>
