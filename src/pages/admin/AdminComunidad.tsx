...
const AdminComunidad = () => {
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Cargando datos de la comunidad...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-extrabold tracking-tight text-foreground sm:text-3xl [text-wrap:balance]">Gestión de Comunidad</h1>
        <p className="text-muted-foreground">Administra categorías, hilos y modera el contenido del foro</p>
      </div>
