        ...
        <div className="max-w-4xl mx-auto py-8">
          <Card>
            ...
            <CardContent className="prose prose-green max-w-none space-y-6">
              <div>
                <h2 className="text-2xl font-semibold text-green-700 mb-4">Información general</h2>
              ...
              <div>
                <h2 className="text-2xl font-semibold text-green-700 mb-4">Objeto</h2>
                <p className="text-gray-700">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-green-700 mb-4">Propiedad intelectual</h2>
                <p className="text-gray-700">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-green-700 mb-4">Legislación aplicable</h2>
                <p className="text-gray-700">
