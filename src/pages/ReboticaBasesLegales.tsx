...
const SECTIONS = [
  ...
  },
  {
    ...
    body: 'Cada cajón abierto, además del premio instantáneo, es una participación automática en dos sorteos adicionales: EL BAÚL, un premio físico que se sortea una vez al mes entre todas las aperturas del mes natural, y EL GORDO, un premio de servicio que se sortea una vez por temporada entre todas las aperturas de esa temporada. Participar en ambos no exige nada adicional: toda apertura cuenta por igual. Su entrega, sin embargo, está sujeta a una condición particular, porque los dos se disfrutan físicamente en una farmacia: solo puede recibirlos quien, en la fecha del sorteo correspondiente, sea titular o cotitular de una oficina de farmacia abierta al público en España; no se entregarán a empleados, colaboradores ni a personas sin esa vinculación, sin perjuicio de que su participación en el resto de la Rebotica siga siendo válida en todo caso. farmapro podrá solicitar al ganador una acreditación razonable de esa condición antes de formalizar la entrega. EL BAÚL consiste en un desayuno dulce para el equipo de la farmacia ganadora (valor aproximado de 45 euros), acompañado únicamente de una tarjeta de la Rebotica, sin personalización. Se entrega única y exclusivamente en la oficina de farmacia del ganador, dentro de su horario de apertura, y nunca en domicilios particulares ni a terceros. Por su naturaleza de sorpresa, EL BAÚL no se comunica previamente al ganador: la propia entrega en la farmacia constituye la comunicación del premio, y farmapro comprobará con carácter previo la condición de titular por medios razonables (datos de la cuenta del portal y registros públicos o colegiales). EL GORDO (la Auditoría Farmacia Silenciosa) se comunica al ganador por correo electrónico y se ejecuta en esa misma farmacia según el protocolo propio del servicio. Si el ganador no reúne la condición de titular, no la acredita en el plazo de siete (7) días naturales desde la comunicación del premio (en el caso de EL GORDO), renuncia a él, o la entrega o ejecución no puede completarse por causas a él imputables o por no constar en su cuenta una oficina de farmacia identificable, el premio se declara desierto respecto de ese ganador y se repite el sorteo entre las restantes participaciones del mismo periodo, aplicándose estas mismas condiciones. Ambos premios son personales e intransferibles y no son canjeables por dinero ni por otros premios.',
  },
  {
