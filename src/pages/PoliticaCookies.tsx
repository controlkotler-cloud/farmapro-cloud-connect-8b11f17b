      ...
      <div className="max-w-4xl mx-auto py-8">
        <Card>
          ...
          <CardContent className="prose prose-blue max-w-none space-y-6">
            <div>
              <h2 className="text-2xl font-semibold text-blue-700 mb-4">¿Qué son las cookies?</h2>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-blue-700 mb-4">Tipos de cookies que utilizamos</h2>
              
              <h3 className="text-xl font-medium text-blue-600 mb-2">Cookies Necesarias</h3>
              ...
              <h3 className="text-xl font-medium text-blue-600 mb-2">Cookies de Análisis</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-medium text-blue-600 mb-2">Cookies de Marketing</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-medium text-blue-600 mb-2">Cookies de Preferencias</h3>
              <p className="text-gray-700 mb-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-blue-700 mb-4">Gestión de cookies</h2>
              <p className="text-gray-700 mb-4">
